...
def run_all_now() -> None:
    ...
    # SQLite on Azure's network share and can corrupt it; one DB writer at a time is
    # far safer. Each run still drips its sends across the day via the email_scheduler.
    try:
